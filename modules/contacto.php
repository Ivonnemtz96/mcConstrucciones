        ...
        <div class="row mb-90">
            <div class="col-md-5 mb-60">
                ...
                <div class="contact-link">
                    ...
                    <div class="contact-link-content">
                        <div class="contact-link-title">Mail</div>
                        <div class="contact-link-text"><a
                                href="mailto:info@mcconstrucciones.com">info@mcconstrucciones.com</a></div>
                    </div>
                </div>
                <div class="contact-link">
                    ...
                    <div class="contact-link-content">
                        ...
                        <div class="contact-link-text">Local #2, calle Baja California E. 7 de Mayo y 15 de Septiembre,
                            Col Zacatal</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-box">
                        ...
                        <form method="POST" action="/php/contact.php">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group">
                                    <input name="asunto" type="text" placeholder="Subject *" required>
                                </div>
                                <div class="col-md-12 form-group">
                                    <textarea name="msj" id="message" cols="30" rows="4" placeholder="Message *"
                                        required></textarea>
                                </div>
                                <div class="row" style="margin-bottom: 3rem; margin-top:3rem;">
                                    <div class="col-12 col-md-5">
                                        ...
                                        <div class="col-md-12">
                                            <button class="button-secondary mt-15"><a
                                                    href="#0"><span>Submit</span></a></button>
                                        </div>
                                    </div>
                        </form>
                    </div>
...
<div class="container-fluid map-color animate-box">
    <iframe
        src="https://www.google.com/maps/embed?pb=!1m21!1m12!1m3!1d334.51266074250515!2d-109.71422702744147!3d23.095016428650645!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m6!3e6!4m3!3m2!1d23.0948149!2d-109.7142104!4m0!5e0!3m2!1ses-419!2smx!4v1673561726126!5m2!1ses-419!2smx"
...
<!-- Faqs -->
<section hidden class="section-padding bg-gray">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <p class="mb-0">Algunas preguntas de clientes</p>
                <div class="section-title">Preguntas <span> Frecuentes</span></div>
            </div>
        </div>
        <div class="row">
            <!-- Accordion -->
